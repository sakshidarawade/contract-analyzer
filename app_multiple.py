...
def handle_userinput(user_question, target_language, response_language, conversation_chain):
...
def main():
    ...
    if user_question:
        handle_userinput(user_question, target_language, response_language, st.session_state.conversation_chain)
